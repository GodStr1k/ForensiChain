...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 text-slate-50 py-12">
      <div className="max-w-md w-full p-8 bg-slate-900 rounded-xl shadow-2xl border border-slate-800">
        <div className="flex justify-center mb-6">
          <Shield className="w-12 h-12 text-emerald-500" />
        </div>
        <h2 className="text-3xl font-bold text-center mb-8">Register Investigator</h2>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 bg-slate-950 border border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-slate-200"
            >
